...
bob.age = 24;
bob.hair = {};
bob.hair.style='spikey';
bob.hair.color='brown';
bob.presidentOfTheUnitedStates = false;
bob.likes = ['apples','bananas','cherries'];
...
function coderTest(object) {
	if (object.name === "Jeremy") {
		return object.lovesCode = 10;
	} else if (object.name === "Brack") {
		return object.lovesCode = 0;
	} else
	   return object.lovesCode = 5;
}
